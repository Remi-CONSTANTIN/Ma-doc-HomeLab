...
Vous avez maintenant plusieurs informations à remplir :
...
PBS inclue donc une vérification et une réparation automatique des sauvegardes afin de garantir de la restaurabilité des données en cas de besoin.
